...
def main():
    ...
    parser.add_argument("--rating", choices=["safe", "sensitive", "nsfw", "explicit"], default="safe")
    ...
    if args.dry_run:
        ...
        image = generate_image(scene_prompt, raw_path, use_lora=use_lora, rating=args.rating)
